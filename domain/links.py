...
class Links():
    _LINK = [
        ...
        "&maxprice=", "&page=", "&sortdirection=ascending&sortby=price&islifeannuity=no&noindex=1"
        ]
    ...
    def __init__(self):
        ...
        page = self.get_page(
            ...
            "types=house,apartment&sortdirection=descending&sortby=price&islifeannuity=no&noindex=1"
        ).content
